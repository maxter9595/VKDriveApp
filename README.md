...
* Ссылка для открытия приложения: [http://95.163.223.130/](http://95.163.223.130/)

* Проверка работы бэкенда приложения: [http://95.163.223.130:20000/api/health](http://95.163.223.130:20000/api/health)
...
* Панель администратора БД (Adminer): [http://95.163.223.130:8080/](http://95.163.223.130:8080/)
...
* Ввод secrets для автодеплоя GitHub-репозитория:
  ...
  * SSH_HOST: ```95.163.223.130``` (или другой IP-адрес сервера)
